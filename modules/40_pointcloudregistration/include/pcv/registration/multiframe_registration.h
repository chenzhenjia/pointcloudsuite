...
struct RobotBaseFrame {
    QString sourceFile;
    QVector<Point3D> fullPoints;
...
struct MultiFrameRegistrationResult {
...
MultiFrameRegistrationResult registerRobotBaseFrames(
    QVector<RobotBaseFrame> inputs,
